...
MKINSTALLDIRS   := /Users/macmini/Documents/RDEWASM/modules/freetype/builds/unix/./install-sh -c -d
...
PKGCONFIG_REQUIRES         := 
PKGCONFIG_REQUIRES_PRIVATE := libpng
PKGCONFIG_LIBS             := -L${libdir} -lfreetype
PKGCONFIG_LIBS_PRIVATE     := -lbz2
LIBSSTATIC_CONFIG          := -lfreetype -lbz2 -L/usr/local/Cellar/libpng/1.6.39/lib -lpng16 -lz
build_libtool_libs         := 
ft_version                 := 24.2.18

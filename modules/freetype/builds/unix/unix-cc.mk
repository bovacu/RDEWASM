...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -fvisibility=hidden -DDARWIN_NO_CARBON  -I/usr/local/Cellar/libpng/1.6.39/include/libpng16 -pthread \
...
# Linker flags.
#
LDFLAGS :=  -lbz2 -L/usr/local/Cellar/libpng/1.6.39/lib -lpng16 -pthread -lpthread

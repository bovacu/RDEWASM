...
TAG = 'version_1'
HASH = 'e256901c00ae5b01735d9255ac83926d466270d617b9e828aebad608759f137c89bf120d2071aa4209f7447b60d15b4ee8fb66834b61a0ed4d32e10aaf01e2a4'
...
def get(ports, settings, shared):
  ...
  def create(final):
    ...
    with open(os.path.join(source_path, 'src/gzip/ftgzip.c'), 'r') as file:
      data = file.readlines()
    data[27] = "#define FT_CONFIG_OPTION_SYSTEM_ZLIB"
    with open(os.path.join(source_path, 'src/gzip/ftgzip.c'), 'w') as file:
